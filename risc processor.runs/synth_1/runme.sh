...
HD_PWD='D:/risc processor/risc processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Risc_32_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Risc_32_bit.tcl
